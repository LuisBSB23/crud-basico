...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css" rel="stylesheet" xintegrity="sha384-..." crossorigin="anonymous">
    <style>
        .product-card {
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="product-card">
                    ...
                    <p class="product-info">ID: {{ $pedido->id }}</p>
                    <p class="product-info">Produto: {{ $pedido->produto }}</p>
                    <p class="product-info">Quantidade: {{ $pedido->quantidade }}</p>
                    <p class="product-info">Preço: {{ number_format($pedido->preco, 2, ',', '.') }} R$</p>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js" xintegrity="sha384-..." crossorigin="anonymous"></script>
</body>
